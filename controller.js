...
const spawnOpts = { 'detached' : true }

var spawn = require('child_process').spawn;    
var minerProcess = require('child_process').spawn('powershell.exe', ['cd $ENV:UserProfile/Desktop/MultipoolMiner/; & .\\startGAZM.bat']);
...
nestApi.login(function(data) {
  nestApi.get(function(data) {
    let shared = data.shared[Object.keys(data.schedule)[0]];
    var zoneDown = _.pick(data.shared, '15AA01AC3217065S')
    res.json(zoneDown)
  });
});
});
